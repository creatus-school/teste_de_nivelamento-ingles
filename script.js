...
function onYouTubeIframeAPIReady() {
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const youtubeVideoContainer = document.getElementById('youtube-video-container'); // Container para o iframe do YouTube
        ...
        const questions = [
            ...
            },
            {
                ...
                youtubeVideoId: 'NUXp1qCFliQ' // <--- SUBSTITUA PELO ID REAL DO SEU VÍDEO DO YOUTUBE
            },
            {
                id: 'q30',
                type: 'listening',
                ...
                youtubeVideoId: 'ID_DO_VIDEO_Q30' // <--- SUBSTITUA PELO ID REAL DO SEU VÍDEO DO YOUTUBE
            },
            {
                id: 'q31',
                type: 'listening',
                ...
                youtubeVideoId: 'ID_DO_VIDEO_Q31' // <--- SUBSTITUA PELO ID REAL DO SEU VÍDEO DO YOUTUBE
            },
            {
                id: 'q32',
                type: 'listening',
                ...
                youtubeVideoId: 'ID_DO_VIDEO_Q32' // <--- SUBSTITUA PELO ID REAL DO SEU VÍDEO DO YOUTUBE
            },
            {
                id: 'q33',
                type: 'listening',
                ...
                youtubeVideoId: 'ID_DO_VIDEO_Q33' // <--- SUBSTITUA PELO ID REAL DO SEU VÍDEO DO YOUTUBE
            },
            {
                id: 'q34',
                type: 'listening',
                ...
                youtubeVideoId: 'ID_DO_VIDEO_Q34' // <--- SUBSTITUA PELO ID REAL DO SEU VÍDEO DO YOUTUBE
            },
            {
                id: 'q35',
                type: 'listening',
                ...
                youtubeVideoId: 'ID_DO_VIDEO_Q35' // <--- SUBSTITUA PELO ID REAL DO SEU VÍDEO DO YOUTUBE
            },
        ];
        ...
        function loadQuestion() {
            ...
            // Limpa o container do vídeo e reseta o overlay
            youtubeVideoContainer.innerHTML = '';
            if (videoOverlayElement) {
                videoOverlayElement.remove(); // Remove o overlay antigo se existir
            ...
            if (question.youtubeVideoId) {
                ...
                // Listener para o overlay para reprodução ILIMITADA
